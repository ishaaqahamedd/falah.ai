---
name: gemini-live-api-2.5
description: "[LEGACY] Gemini 2.5 Flash Live API skill. Use this ONLY when working with the deprecated gemini-2.5-flash-native-audio-preview-12-2025 model. Supports affective dialog, proactive audio, and async function calling. For new development, use the gemini-live-api-3.1 skill instead."
---

# Gemini Live API Development Skill (Legacy — Gemini 2.5)

> [!WARNING]
> **This skill targets the deprecated `gemini-2.5-flash-native-audio-preview-12-2025` model.** For new projects, use the `gemini-live-api-3.1` skill with `gemini-3.1-flash-live-preview`. See the [migration guide](../gemini-live-api-3.1/SKILL.md#migrating-from-gemini-25-flash-live) in the new skill.
